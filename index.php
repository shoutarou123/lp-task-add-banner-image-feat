...
<head>
  ...
  <title>SkillRelay（スキルリレー） | 株式会社taiziii（タイジー） </title>
  <meta name="description" content="ベテラン社員の経験やノウハウを、AIで誰もが使える知識資産に変換しませんか？">

  <!-- OGP -->
  <meta property="og:title" content="SkillRelay（スキルリレー） | 株式会社taiziii（タイジー）">
  <meta property="og:description" content="ベテラン社員の経験やノウハウを、AIで誰もが使える知識資産に変換しませんか？">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://taiziii.com/skillrelay/">
  <meta property="og:site_name" content="SkillRelay（スキルリレー）">
  <meta property="og:image" content="https://taiziii.com/skillrelay/OGP.png">
  ...
  <meta name="twitter:title" content="SkillRelay（スキルリレー） | 株式会社taiziii（タイジー）">
  <meta name="twitter:description" content="ベテラン社員の経験やノウハウを、AIで誰もが使える知識資産に変換しませんか？">
  <meta name="twitter:image" content="https://taiziii.com/skillrelay/OGP.png">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@100..900&family=Protest+Strike&family=Roboto:ital,wght@0,100..900;1,100..900&family=Zen+Kaku+Gothic+New&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&family=Noto+Sans+JP:wght@100..900&family=Protest+Strike&family=Roboto:ital,wght@0,100..900;1,100..900&family=Zen+Kaku+Gothic+New&display=swap" rel="stylesheet">
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-PPKLD6Y7QJ"></script>
  <script>
    ...
    <div class="bg_img">
      ...
      <div class="flex">
        ...
        <div class="section_text_content">
          <div class="blue_rectangle_content">
            <div class="blue_rectangle"></div>
            <p class="blue_rectangle_text">CHALLENGE</p>
          </div>
      ...
      <div class="earth_content_block">
        <div class="earth_bg_img">
          <div class="fukidashi_content">
            ...
            <div class="fukidashi_bg_img two">
              <p>
                知識が共有され組織が強くなる
              </p>
            </div>
            <div class="fukidashi_bg_img three">
              <p>
                教育・育成のコストを削減できる
              </p>
            </div>
    ...
    <div class="scroll_wrapper">
      <div class="four_box_flex">
        <div class="box_content first">
          <div class="box_title_content sp">
            <p>比較項目</p>
          </div>
          <div class="box_text_content sp one">
            <p>知識継承の深さ</p>
          </div>
          <div class="box_text_content sp two">
            <p>思考プロセスの再現性</p>
          </div>
          <div class="box_text_content sp three">
            <p>投資対効果・持続性</p>
          </div>
        </div>
      ...
      <div class="faq_flex">
        ...
        <div class="qa_content">
          <div class="q_flex">
            <img
              class="q_img"
              src="./img/pc/q-icon.png"
              alt="Qアイコン画像" />
            <p>導入にはどのくらいの期間がかかりますか？</p>
            <div class="minus_plus_img_content">
              <img
                class="minus_img hidden"
                src="./img/pc/mainasu-icon.png"
                alt="マイナスアイコン画像" />
              <img
                class="plus_img"
                src="./img/pc/plus-icon.png"
                alt="プラスアイコン画像" />
            </div>
          </div>
  ...
  <section class="banner_section" id="bannerSection">
    ...
    <a href="https://taiziii.com/skillrelay/knowledge-transfer-report-2025">
      <img
        ...
        srcset="./img/banner/banner.png 2x,
                ./img/banner/banner.png 1x"
        alt="バナー画像" />
    </a>
  </section>
...
<script>
  function lazyAnalyticsScript() {
    function oneTimeFunction() {
      ...
      })(window, document, 'script', 'dataLayer', 'G-PZWCYTX7BE');

      const adScript = document.createElement("noscript");
      const adIframe = document.createElement("iframe");
      adIframe.src = "https://www.googletagmanager.com/ns.html?id=G-PZWCYTX7BE";
    ...
    let scrollFirstTime = true;
    setTimeout(oneTimeFunction, 4000);
